...
A biomechanical analysis tool for Pickleball coaches. Uses MediaPipe Pose Estimation to automatically detect and classify Dinks and Smashes from video footage using joint angle trigonometry and spatial tracking.
